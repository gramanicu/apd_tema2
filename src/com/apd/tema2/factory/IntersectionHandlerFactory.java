...
public class IntersectionHandlerFactory {
    public static IntersectionHandler getHandler(String handlerType) {
        ...
        return switch (handlerType) {
            case "simple_semaphore", "simple_n_roundabout", "simple_strict_1_car_roundabout", "simple_strict_x_car_roundabout", "priority_intersection", "simple_max_x_car_roundabout", "crosswalk" -> car -> Main.intersection.wait_in_intersection(car);
